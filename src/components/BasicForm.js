...
const BasicForm = (props) => {
  ...
  const submitHandler = event => {
    ...
    const result = {
     id:  idValue,userId: userIdValue, title: titleValue
    }
  ...
  const userIdClasses = userIdHasError ? 'form-control invalid' : 'form-control';
    ...
    <form onSubmit={submitHandler}>
      <div className='control-group'>
        <div className={idClasses}>
          ...
          />
          {idHasError && <p className="error-text">Please enter a first name.</p>}
        </div>
        <div className={userIdClasses}>
          ...
          />
          {userIdHasError && <p className="error-text">Please enter a last name.</p>}
        </div>
      </div>
      <div className={titleClasses}>
        ...
        />
        {titleHasError && <p className="error-text">Please enter a valid title address.</p>}
      </div>
